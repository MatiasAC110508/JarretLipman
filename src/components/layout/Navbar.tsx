...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-0 bg-white z-[100] lg:hidden flex flex-col transition-transform duration-300 ease-in-out",
          isOpen
            ? "translate-x-0"
      ...
      >
        {/* Mobile Modal Header */}
        <div className="flex items-center justify-between px-4 md:px-6 py-5 border-b border-brand-100 shrink-0">
          <Link
            href="/"
          ...
          <button
            className="p-2 text-brand-900 hover:bg-brand-50 rounded-lg transition-colors"
            onClick={() => setIsOpen(false)}
        ...
        {/* Mobile Nav Links */}
        <div className="overflow-y-auto flex-1 overscroll-none pb-8">
